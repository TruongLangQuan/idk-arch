            ...
            Item {
                ...
                StyledImage {
                    ...
                    source: {
                        ...
                        const isLive = p === "cmatrix" || p === "blackhole" || p === "atom" || p === "butterfly" || p === "chaos" || p === "nbody" || p === "bitnet" || p === "ascii";
                        return isLive ? "" : p;
                    }
                    cache: false
                    layer.enabled: true
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        MaterialSymbol {
                            ...
                            text: {
                                const p = Config.options.background.wallpaperPath;
                                if (p === "cmatrix") return "data_array";
                                if (p === "blackhole") return "cyclone";
                                if (p === "atom") return "motion_photos_on";
                                if (p === "butterfly") return "flutter_dash";
                                if (p === "chaos") return "gesture";
                                if (p === "nbody") return "grain";
                                if (p === "bitnet") return "hub";
                                if (p === "ascii") return "terminal";
                                return "wallpaper";
                            }
                            iconSize: 48
                        ...
                        StyledText {
                            ...
                            text: {
                                const p = Config.options.background.wallpaperPath;
                                if (p === "cmatrix") return "CMatrix Rain";
                                if (p === "blackhole") return "Blackhole";
                                if (p === "atom") return "Atom Orbit";
                                if (p === "butterfly") return "Butterfly Effect";
                                if (p === "chaos") return "Chaos Theory";
                                if (p === "nbody") return "N-Body Gravitation";
                                if (p === "bitnet") return "Bitnet Simulator";
                                if (p === "ascii") return "ASCII Art";
