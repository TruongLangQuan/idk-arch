...
ContentPage {
    ...
    ContentSection {
        icon: "play_circle"
        title: Translation.tr("Live Wallpaper")

        ConfigSelectionArray {
            Layout.fillWidth: true
            currentValue: {
                const val = Config.options.background.wallpaperPath;
                if (val === "cmatrix" || val === "blackhole" || val === "atom" || val === "butterfly" || val === "chaos" || val === "nbody" || val === "bitnet" || val === "ascii") {
                    return val;
                }
                return "none";
            }
            onSelected: newValue => {
                if (newValue === "none") {
                    Config.options.background.wallpaperPath = FileUtils.trimFileProtocol(`${Directories.assetsPath}/images/default_wallpaper.png`);
                } else {
                    Config.options.background.wallpaperPath = newValue;
                }
            }
            options: [
                {
                    displayName: Translation.tr("Disabled / None"),
                    icon: "block",
                    value: "none"
                },
                {
                    displayName: Translation.tr("CMatrix Rain"),
                    icon: "data_array",
                    value: "cmatrix"
                },
                {
                    displayName: Translation.tr("Blackhole"),
                    icon: "cyclone",
                    value: "blackhole"
                },
                {
                    displayName: Translation.tr("Atom Orbit"),
                    icon: "motion_photos_on",
                    value: "atom"
                },
                {
                    displayName: Translation.tr("Butterfly Effect"),
                    icon: "flutter_dash",
                    value: "butterfly"
                },
                {
                    displayName: Translation.tr("Chaos Theory"),
                    icon: "gesture",
                    value: "chaos"
                },
                {
                    displayName: Translation.tr("N-Body Gravitation"),
                    icon: "grain",
                    value: "nbody"
                },
                {
                    displayName: Translation.tr("Bitnet Simulator"),
                    icon: "hub",
                    value: "bitnet"
                },
                {
                    displayName: Translation.tr("ASCII Art"),
                    icon: "terminal",
                    value: "ascii"
                }
            ]
