...
Singleton {
    ...
    ColorQuantizer {
        ...
        readonly property bool isLiveWallpaper: {
            ...
            return p === "cmatrix" || p === "blackhole" || p === "atom" || p === "butterfly" || p === "chaos" || p === "nbody" || p === "bitnet";
        }
        source: isLiveWallpaper ? "" : Qt.resolvedUrl(wallpaperIsVideo ? Config.options.background.thumbnailPath : Config.options.background.wallpaperPath)
        depth: 0 // 2^0 = 1 color
        rescaleSize: 10
    }
